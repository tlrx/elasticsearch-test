...
puts ""
puts "@RunWith(ElasticsearchRunner.class)"
puts "public class VersionTest {"
puts "	@ElasticsearchNode"
puts "	Node node;"
puts ""	
puts "	@Test"
puts "	public void test(){"
puts "		// Use of node"
puts "	}"
puts "}"
</pre>
...
<pre>@ElasticsearchNode(name = "node3", clusterName = "fourth-cluster-name", local = true, data = false)
Node node3;
</pre>
