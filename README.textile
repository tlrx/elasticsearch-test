...
h3. Using the Test API

The @EsSetup@ class can be used to start and stop a local ElasticSearch node. Then, the @EsSetup.execute()@ method 
can be used to create or delete indices and import test data.

Here is a typical usage of @EsSetup@:
<pre>import static com.github.tlrx.elasticsearch.test.EsSetup.*;
