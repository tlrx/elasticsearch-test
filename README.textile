...
<pre>package fr.tlrx.elasticsearch.samples.core;
...
Used to instantiate an elasticsearch @TransportClient@. The TransportClient can be local if needed (but you should consider using @ElasticsearchClient instead).
...
You can also look at "the unit tests for some inspiration":https://github.com/tlrx/elasticsearch-test/tree/master/src/test/java/fr/tlrx/elasticsearch
