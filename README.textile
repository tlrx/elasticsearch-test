...
<pre>package fr.tlrx.elasticsearch.samples.core;<br/>
<br/>
@RunWith(ElasticsearchRunner.class)<br/>
public class VersionTest {<br/>
<br/>
	@ElasticsearchNode<br/>
	Node node;<br/>
<br/>	
	@Test<br/>
	public void test(){<br/>
...
<pre>@ElasticsearchNode(name = "node3", clusterName = "fourth-cluster-name", local = true, data = false)<br/>
Node node3;
</pre>
